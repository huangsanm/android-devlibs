...
public class SPUtils {
     ...
     * @param prefixKey
     */
    public static void removeByPrefix(Context context, String prefixKey) {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME, Context.MODE_APPEND);
        Map<String, ?> parmas = sp.getAll();
        for (String s : parmas.keySet()) {
    ...
    public static class CacheKey {
        ...
        public static final String USERPWD = "PWD_KEY";
        public static final String FIRST_START = "FIRST_START";
        public static final String VERSION_KEY = "VERSION_KEY";
        public static final String SUSPENSIONADATE= "SUSPENSIONADATE";
        public static final String SUSPENSIONADATA= "SUSPENSIONADATA";
        public static final String OVERALADATA= "OVERALADATA";
